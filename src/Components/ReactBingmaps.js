...
class ReactBingmaps extends Component {
	...
	componentWillReceiveProps(nextProps){
		...
		if(this.props.mapPolygons !== nextProps.mapPolygons){
			this.createPolygons(nextProps.mapPolygons, mapReference);
		}		
	...
	reactBingmaps(props,  Microsoft){
		...
		if(bingmapKey && Microsoft){
			...
			this.createPolygons(mapPolygons,mapReference);
	...
	createPolygons(regularPolygons, mapReference){
